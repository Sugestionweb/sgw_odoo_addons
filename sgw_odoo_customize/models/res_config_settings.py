...
class ResConfigSettings(models.TransientModel):
    ...
    app_show_support = fields.Boolean('Show Support', help=u"When enable,User can visit your support site")
    ...
    def get_values(self):
        ...
        app_support_url = ir_config.get_param('app_support_url', default='https://www.sugestionweb.com/trial/')
        app_account_title = ir_config.get_param('app_account_title', default='My Online Account')
        app_account_url = ir_config.get_param('app_account_url', default='https://www.sugestionweb.com/my-account/')
        app_enterprise_url = ir_config.get_param('app_enterprise_url', default='https://www.sugestionweb.com')
        res.update(
    ...
    def set_values(self):
        ...
        ir_config.set_param("app_documentation_url",
                            self.app_documentation_url or "https://www.sugestionweb.com/documentation/user/12.0/en/index.html")
        ir_config.set_param("app_documentation_dev_url",
                            self.app_documentation_dev_url or "https://www.sugestionweb.com/documentation/12.0/index.html")
        ir_config.set_param("app_support_url", self.app_support_url or "https://www.sugestionweb.com/trial/")
        ir_config.set_param("app_account_title", self.app_account_title or "My Online Account")
        ir_config.set_param("app_account_url", self.app_account_url or "https://www.sugestionweb.com/my-account/")
        ir_config.set_param("app_enterprise_url", self.app_enterprise_url or "https://www.sugestionweb.com")
